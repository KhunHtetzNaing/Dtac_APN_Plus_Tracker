...
public class about extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.htetznaing.dtacapntracker0", "com.htetznaing.dtacapntracker0.about");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.htetznaing.dtacapntracker0", "com.htetznaing.dtacapntracker0.about");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.dtacapntracker0.about", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
public com.htetznaing.dtacapntracker0.main _main = null;
...
anywheresoftware.b4a.objects.LabelWrapper _lblcredit = null;
 ...
 //BA.debugLineNum = 23;BA.debugLine="AdView1.Initialize(\"ad\",\"ca-app-pub-4173348573252";
...
mostCurrent._adview1.LoadAd();
 //BA.debugLineNum = 25;BA.debugLine="Activity.AddView(AdView1,0%x,100%y - 50dip,100%x,";
...
mostCurrent._interstitial.LoadAd();
 //BA.debugLineNum = 30;BA.debugLine="t2.Initialize(\"t2\",30000)";
_t2.Initialize(processBA,"t2",(long) (30000));
 //BA.debugLineNum = 31;BA.debugLine="t2.Enabled = True";
_t2.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 35;BA.debugLine="Activity.Title = \"About\"";
mostCurrent._activity.setTitle((Object)("About"));
 //BA.debugLineNum = 36;BA.debugLine="Activity.Color = Colors.RGB (235,235,235)";
...
_imvlogo = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 39;BA.debugLine="imvLogo.Initialize (\"\")";
_imvlogo.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 40;BA.debugLine="imvLogo.Bitmap = LoadBitmap(File.DirAssets , \"log";
...
_bg.Initialize(anywheresoftware.b4a.keywords.Common.Colors.DarkGray,anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10)));
 //BA.debugLineNum = 47;BA.debugLine="lblName.Initialize (\"\")";
...
_lblname.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 50;BA.debugLine="lblName.Text = \"Dtac APN + Tracker\"";
...
mostCurrent._lstone.AddSingleLine2("Website : www.HtetzNaing.com    ",(Object)(2));
 //BA.debugLineNum = 67;BA.debugLine="lstOne.AddSingleLine2 (\"Facebook : www.facebook.c";
...
_lblcredit.Initialize(mostCurrent.activityBA,"lblCredit");
 //BA.debugLineNum = 72;BA.debugLine="lblCredit.TextColor = Colors.RGB (48,154,6)";
...
_lblcredit.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 75;BA.debugLine="lblCredit.Text = \"B4x Myanmar Programmers Group\"";
_lblcredit.setText((Object)("B4x Myanmar Programmers Group"));
 //BA.debugLineNum = 76;BA.debugLine="Activity.AddView (lblCredit, 10dip, 310dip, 100%x";
...
public static String  _lblcredit_click() throws Exception{
 //BA.debugLineNum = 81;BA.debugLine="Sub lblCredit_Click";
 //BA.debugLineNum = 82;BA.debugLine="StartActivity(p.OpenBrowser (\"https://www.faceboo";
...
anywheresoftware.b4a.objects.IntentWrapper _i = null;
 //BA.debugLineNum = 92;BA.debugLine="Sub lstOnes_ItemClick (Position As Int, Value As O";
 //BA.debugLineNum = 93;BA.debugLine="Select Value";
switch (BA.switchObjectToInt(_value,(Object)(2),(Object)(3))) {
case 0: {
 //BA.debugLineNum = 95;BA.debugLine="Dim Facebook As Intent";
_facebook = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 96;BA.debugLine="Facebook.Initialize(Facebook.ACTION_VIEW, \"http";
_facebook.Initialize(_facebook.ACTION_VIEW,"http://www.htetznaing.com");
 //BA.debugLineNum = 97;BA.debugLine="StartActivity(Facebook)";
...
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_facebook.getObject()));
			...
			processBA.setLastException(e12); //BA.debugLineNum = 108;BA.debugLine="Dim i As Intent";
...
public static String  _t2_tick() throws Exception{
 //BA.debugLineNum = 118;BA.debugLine="Sub t2_Tick";
 //BA.debugLineNum = 119;BA.debugLine="If Interstitial.Ready Then Interstitial.Show Els";
